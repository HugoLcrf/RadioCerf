...
import FractalTree from "./objects/FractalTree";
import RadioWave from "./objects/RadioWave";
...
class Scene {
  ...
  addObjects() {
    ...
    this.fractalTree = new FractalTree();
    this.radioWave = new RadioWave();

    // Position caméra par défaut
    this.camera.position.z = 20;

    // Objet affiché par défaut
  ...
  pickVisualizer(index) {
    ...
    switch (index) {
      ...
      case 4:
        this.fractalTree = new FractalTree();
        this.currentObject = this.fractalTree;
        break;
      case 5:
        this.camera.position.z = 20;
        this.currentObject = this.radioWave;
        break;
      default:
        break;
    }
